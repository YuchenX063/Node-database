...
@Component({
  ...
  templateUrl: './subset-vs-whole.component.html',
  styleUrl: './subset-vs-whole.component.scss'
})
export class SubsetVsWholeDashboardComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  // Actual year span where the chosen subset has any institutions — drives the
  // order caveat so it stays accurate as more years are tagged
  ...
  private render(): void {
    ...
    g.append('text').attr('transform', 'rotate(-90)')
      ...
      .text(indexed ? `Indexed to ${this.baseYear} = 100` : 'Institutions recorded');
